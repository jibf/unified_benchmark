...
def similarity(str1, str2):
    ...
    # return total_defeine_argument, total_transfer_var


def groundcheck(informationmatrix):  # ground truth extraction & self-test
...
def cross_check(groundtruth: list, reaction: list, mode: str):
    totalcount = groundcheck(groundtruth)
...
def file_compare(groundtruth: list, totalcount: list, reaction: list, mode: str):
    ...
    if react_list:
        sub_task_details -= groundcheck(react_list)
...
def callcompare(ground_sequence, totalcount, pre_sequence, mode):
